...
class SapPointsBase(SapBase):
  ...
  def get_cylindrical(self, name, csys="Global"):
    ...
    theta and z coordinates of the specified point object/element in the Present Units. 
  ...
  def get_all(self, format):
    '''
    The function returns zero if the coordinates are successfully returned; 
    otherwise it returns nonzero. If successful, the function returns a dictionary
    containing the name of all the objects/elements along with their coordinates
    in the specified format. The default format is Cartesian.
    '''
...
class SapPointObjects(SapPointsBase):
  ...
  def addcartesian(self,pos,name = "1", csys = "Global", mergeOff = False, mergeNumber = 0):
    '''
    This function adds a point object to a model. The added point object will be tagged as a Special Point 
    except if it was merged with another point object. Special points are allowed to exist in the model 
    with no objects connected to them.
  ...
  def addcylindrical(self,pos,name = "1", csys = "Global", mergeOff = False, mergeNumber = 0):
    '''
    Same as addcartesian but in Cylindrical Coordinates instead. Therefore pos should be in the
    form (r, theta, z)
    '''
    r, theta ,z = pos
  ...
  def addspherical(self,pos,name = "1", csys = "Global", mergeOff = False, mergeNumber = 0):
    '''
    Similar to addcartesian and addcylindrical but in Spherical Coordinates instead. Therefore,
